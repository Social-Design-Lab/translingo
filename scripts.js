...
function retranslate(temp) {
  ...
  if (transOutput && transOutput.value !== "English Output...") {
    ...
    switch (condition) {
      ...
      case 'sh':
        if (temp == 1) {
          newtrans = "A long time ago, in a small village, there was a beautiful and magical flower garden. Every day, the village children would visit the garden to play and pick their favorite flowers. This garden was full of colorful and sweet-smelling flowers, which made the garden a happy place for everyone.\n \nOne sunny day, a girl named Lily discovered that, if she sang to the flowers, they became even prettier. She was so happy so she shared the secret with her friends. The children decided to play a game to see whose singing would make a flower grow the most. \n \nEach child picked a flower and began singing to it. While they sang, the flowers seemed to dance and their colors became brighter. The children’s laughter filled the air as they watched the garden transform into a magical wonderland.\n \nAs the sun was beginning to set, the children wanted to see whose flower had grown the most. To the children’s surprise, all of the flowers had grown equally, so it was impossible to choose a winner. The children agreed that the garden itself was the real winner because it was so full of joy and happiness.\n \nFrom that day on, the children would gather in the garden to sing to the flowers every day to make the garden even more magical. The flower garden became a symbol of friendship, love, and unity in the village. All of the children learned how important it was to work together and spread happiness."; // translate the first given text of condition sg
          // translatedText1 = translatedText; 
        } else if (temp == 2) {
          newtrans = "In a small village,  there once was a special cloud that could change colors. This cloud was known as the Rainbow Cloud. Every day, it would appear in the sky, spreading joy and happiness to everyone who saw it. One day, a group of children decided to find the Rainbow Cloud and learn the secret behind its beautiful colors. The children began by following the cloud as it drifted across the sky. \n \nAs they walked, the children met a wise, old man. He told them that the Rainbow Cloud got its colors by helping others. Intrigued, the children continued their journey, determined to see the cloud in action. \n \nSoon after, the children saw a sad little girl who had lost her kitten. The Rainbow Cloud heard her cries and swooped down, lifting the kitten from a tall tree and gently placing it in her arms. As it did so, the cloud changed from red to orange. Next, the children saw an old lady struggling to carry a heavy basket of fruits. The Rainbow Cloud noticed her struggling and gently lifted the basket, carrying it to her home. As it helped, the cloud turned from orange to yellow. \n \nThroughout the day, the children saw the Rainbow Cloud helping people and, each time, changing to a new color. By the end of the day, the cloud had transformed into a beautiful, vibrant rainbow. \n \nThe children realized that the secret of the Rainbow Cloud was kindness. They returned to their village, inspired to spread love and joy, just like the Rainbow Cloud. From that day on, the village became a happier place, and the Rainbow Cloud continued to bring color and joy to everyone it met."; // translate the second given text of condition sg
          //translatedText2 = translatedText; 
        } else {
          newtrans = 'Sorry, your input is invalid. '; // handle other input texts
        }
      ...
      case 'ch':
        if (temp == 1) {
          newtrans = "From Sextus, I learned calmness, the organization of a family run with paternal affection, and a way to live according to nature. To be serious without ego, to observe carefully the different dispositions of my friends, to not be offended by those less intelligent or to not be unreasonably set on changing those with vulgar opinions with the theorems and tenets of philosophers. His conversation is an example of how one may accommodate himself to all companies so that, though their company may be sweeter and more pleasing than any flatter’s deception and fawning, he remains respected and reverent. He also showed true excitement and a capacity, both rationally and methodically, to find out and set in order all necessary needs and tasks for life. A man without even the least appearance of anger, or any other passion who observes the “Stoic Apathia,” or unpassionateness, and is still tender-hearted. He is trustworthy but never made a fuss or drew attention to himself. He is very learned and yet makes little show of it. \n \nFrom Alexander the Grammarian, I learned to be blameless myself and to not apprehend any man for barbarism, grammatical mistakes, or any false pronunciation. Rather by my answer, testimony, or confirmation of the same matter (while not drawing attention to the error), I speak as it should have been spoken. Or by some other close and indirect admonishment, while being kind and civil."; // translate the first given text of condition cg
          //translatedText1 = translatedText; 
        } else if (temp == 2) {
          newtrans = "From Apollonius, I learned true freedom, consistency, and to not pay attention to anything, no matter how little, but what is right and reasonable. And always, whether it be the sharpest pains, or after the loss of a child, or during long diseases, to be the same man. The man who was a present and visible example to me showed that it was possible for the same man to be both passionate and calm. A man who is not subject to anger and offended by the incapacity of his scholars and students in his lectures, which is a true pattern of a man who, of all his good gifts and faculties, is humble with himself and his most excellent skill and ability is to teach and persuade others of the common theorems and maxims of Stoic philosophy. From him, I also learned how to receive favors and kindness (as they are commonly known) from friends without becoming obnoxious to them. I will also not ignore them, as an unsensible and unthankful man would.\n \nFrom Catulus, I learned not to blame any friend’s arguing, even if it is unjust, but to strive to calm him to his former mood, to speak freely and heartily well of all my instructors upon any occasion, as did Domitius and Athenodotus, and to love with children wholly."; // translate the second given text of condition cg
          // translatedText2 = translatedText; 
        } else {
          newtrans = 'Sorry, your input is invalid.'; // handle other input texts
        }
